...
void MultimediaConsumer<Parent>::StartApplication() // Called at time specified by Start
{
    ...
    if (m_mpdUrl.find(delim) == 0) {
        ...
        super::SetAttribute("RemoteHostName", StringValue(hostname));
    ...
    NS_ASSERT_MSG(mPlayer->GetAdaptationLogic() != NULL, "Could not initialize adaptation logic...");
